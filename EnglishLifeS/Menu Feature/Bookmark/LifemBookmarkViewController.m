...
@interface LifemBookmarkViewController ()
{
    NSMutableArray *resultArray;
}
@end

@implementation LifemBookmarkViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LifeDetailViewController *cc = [[LifeDetailViewController alloc] initWithIndex:[[resultArray objectAtIndex:indexPath.row] objectAtIndex:0]];
