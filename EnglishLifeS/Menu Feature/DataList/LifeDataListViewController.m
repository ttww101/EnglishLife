...
@interface LifeDataListViewController ()
{
    NSString *gheikcmaeoxqname;
    NSString *gheikcmaeoxqurl;
    NSMutableArray *gheikcmaeoxqresultArray;
    NSInteger gheikcmaeoxqpage;
}
@end

@implementation LifeDataListViewController
...
-(id)initWithURL:(NSString *)__url AndName:(NSString *)__name {
    ...
    if (self) {
        //左侧按钮
        gheikcmaeoxqname = __name;
        gheikcmaeoxqurl = __url;
        self.navigationItem.title = gheikcmaeoxqname;
    }
    return self;
}
...
- (void)loadData{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@",gheikcmaeoxqurl,(long)gheikcmaeoxqpage,MAX_PAGE_COUNT];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *info = [gheikcmaeoxqresultArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LifeDetailViewController *cc = [[LifeDetailViewController alloc] initWithIndex:[[gheikcmaeoxqresultArray objectAtIndex:indexPath.row] objectForKey:@"ID"]];
