...
@interface LifeSideMenuViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation LifeSideMenuViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"type"] isEqualToString:@"index"]) {
        //首頁
        selectViewController = [[LifeHomeViewController alloc] init];
        
    } else if ([[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"type"] isEqualToString:@"list"]) {
        //資料頁
        selectViewController = [[LifeDataListViewController alloc] initWithURL:[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"apiurl"] AndName:[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"title"]];
        [self.sideMenuViewController hideMenuViewController];
    } else if ([[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"type"] isEqualToString:@"fav"]) {
        //收藏
        selectViewController = [[LifemBookmarkViewController alloc] init];
        [self.sideMenuViewController hideMenuViewController];
    } else if ([[[self.resultArray objectAtIndex:indexPath.row] objectForKey:@"type"] isEqualToString:@"more"]) {
        //更多
        selectViewController = [[LifeMoreViewController alloc] init];
        [self.sideMenuViewController hideMenuViewController];
